...
public class App {
    ...
    public static String convertirVelocidad(double kmPorSeg) {
        try {
            ...
            double metrosPorHora = metrosPorSegundo * 3600; //metrosporseg = kmporseg * 1000
            return (int)metrosPorSegundo + "|" + (int)metrosPorHora;
        } catch (Exception e) {
            return "0|0";
        }
    }
    ...
    public static int convertirCcALitros(double cc) {
        try {
            double litros = cc / 1000; // 1 litro = 1000 cc
            return (int) litros;
        } catch (Exception e) {
            return -1;
        }
    ...
    public static int calcularCombustible(double ruta1, double ruta2, double ruta3, double ruta4) {
        double despegue = 1.2;
            ...
            double total_ruta1 = ((ruta1/Valor2*Valor1)+ despegue + aterrizaje);

            double total_ruta2 = ((ruta2/Valor2*Valor1)+ despegue + aterrizaje);

            double total_ruta3 = ((ruta3/Valor2*Valor1)+ despegue + aterrizaje);

            double total_ruta4 = ((ruta4/Valor2*Valor1)+ despegue + aterrizaje);

            double Combustible_total = total_ruta1 + total_ruta2 + total_ruta3 + total_ruta4;
    ...
    public static int calcularPesoLunar(double pesoTierra) {
        try {
            double gravedadLuna = (1.17);
            double pesoNeto = gravedadLuna * pesoTierra;
            return (int)pesoNeto;
        } catch (Exception e) {
            return -1;
        }
    ...
    public static int calcularPuntosFutbol(int ganados, int perdidos, int empatados) {
        try {
            double victorias = ganados * 3;
            double puntosFinales = victorias + empatados;
    ...
    public static int calcularNotaNecesaria(double porcentaje1, double porcentaje2, double porcentaje3, double porcentaje4, double porcentaje5, double nota1, double nota2, double nota3, double nota4) {
        try {
            double NotasDeClase = (nota1 * porcentaje1 + nota2 * porcentaje2 + nota3 * porcentaje3 + nota4 * porcentaje4);
            double NotaNecesaria = (int)(3 - NotasDeClase) / (int)porcentaje5;
    ...
    public static int calcularSalario(int horasNormales, int horasExtrasDiurnas, int horasExtrasNocturnas, double valorHoraNormal) {
        try {
            ...
            double salarioExtraDiurno = horasExtrasDiurnas * (valorHoraNormal * 1.15);
            double salarioExtraNocturno = horasExtrasNocturnas * (valorHoraNormal * 1.35);
            double salarioTotal = salarioNormal + salarioExtraDiurno + salarioExtraNocturno;
    ...
    public static int calcularAreaTriangulo(double base, double altura) {
        try {
            ...
            return (int)AreaTrianguloRectangulo;
        } catch (Exception e) {
            return -1;
        }
    }
    ...
    public static int calcularVolumenCilindro(double radio, double altura) {
        try {
            double volumenCilindro = Math.PI * altura * Math.pow(radio,2);
    ...
    public static int calcularAreaCirculo(double radio) {
        try {
            double AreaDeCirculo = Math.PI * Math.pow(radio, 2);
            return (int)AreaDeCirculo;
        } catch (Exception e) {
            return -1;
        }
    }
